...
이 프로젝트는 C#, C++, C, Python 각각의 언어에 대한 예제 코드를 포함하는 하위 폴더를 만들어 CI/CD 파이프라인을 테스트합니다.
...
- **GitHub 작업**: GitHub Copilot이 CI/CD 관련 작업을 주로 담당합니다.
- **기타 작업**: Gemini가 프로젝트의 나머지 작업을 전담합니다.